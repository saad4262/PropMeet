...
//   final ProfileSetupAgent controller = Get.put(ProfileSetupAgent());
...
//                   index,
//                   pageData["question"] as String,
//                   (pageData["options"] as List?)?.cast<String>() ??
//                       [], // ✅ safe
//                   tags: (pageData["tags"] as List?)?.cast<String>(), // ✅ safe
//                   subQuestion: pageData["subQuestion"] as String?,
//                   subOptions: (pageData["subOptions"] as List?)?.cast<String>(),
//                   images: (pageData["images"] as List?)?.cast<String>(),
//                 );
//               },
//             ),
//           ),
